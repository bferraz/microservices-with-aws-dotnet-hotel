...
namespace LambdaAuthorizer
{
    public class Authorizer
    {
        public async Task<APIGatewayCustomAuthorizerResponse> Auth(APIGatewayCustomAuthorizerRequest request)
        {
            ...
            Console.WriteLine($"ExpectedGroup: {expectedGroup.Value}");

            // We used the KeyValuePair default here, because the result of the operation above not returns null
